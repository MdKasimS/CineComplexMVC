...
namespace CineComplex_MVC.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Price,ReleaseDate,Genre")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price,ReleaseDate,Genre")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
